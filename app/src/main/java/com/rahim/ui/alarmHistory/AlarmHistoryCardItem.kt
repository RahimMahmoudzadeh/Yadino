...
fun AlarmHistoryCardItem(
  ...
  val textAlpha = if (routineModel.isChecked) 0.6f else 1f
  Card(
    ...
    Row(
      ...
      Text(
        text = "زمان: ${routineModel.timeHours}  تاریخ: ${"${routineModel.yerNumber}/${routineModel.monthNumber}/${routineModel.dayNumber}"}",
