package com.rahim.yadino.routine.presentation.ui.main.component
...
class MainRoutineComponentImpl(
  ...
  override fun onEvent(event: MainRoutineComponent.Event) {
    when (event) {
      is MainRoutineComponent.Event.CheckedRoutine -> checkedRoutine(event.routine)
      is MainRoutineComponent.Event.ShowErrorRemoveRoutineDialog -> showErrorDialogRemoveRoutine(event.errorDialogRemoveRoutineUiModel)
      is MainRoutineComponent.Event.GetRoutines -> {
        event.run {
      ...
      is MainRoutineComponent.Event.SearchRoutineByName -> {
        getRoutines(searchText = event.routineName)
      }

      is MainRoutineComponent.Event.ShowUpdateDialog -> showUpdateDialog(event.routine)
      is MainRoutineComponent.Event.GetAllTimes -> getTimes()
