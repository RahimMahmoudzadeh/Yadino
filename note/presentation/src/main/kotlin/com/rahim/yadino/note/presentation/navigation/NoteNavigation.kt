...
import com.rahim.yadino.note.presentation.NoteRoute

fun NavController.navigateToNote(navOptions: NavOptions? = null) {
  this.navigate(Destinations.Note.route, navOptions)
}

fun NavGraphBuilder.noteScreen(openDialog: Boolean, clickSearch: Boolean, onOpenDialog: (isOpen: Boolean) -> Unit) {
